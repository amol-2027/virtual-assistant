...
function SignIn() {
  ...
  const { serverUrl, setUserData, user } = useContext(userDataContext);
      ...
      >
        ...
        >
          <input
            ...
            outline-none border-2  bg-transparent 
             placeholder-gray-300 px-[20px]  py-[10px] rounded-full
            "
            required
        ...
        <button
          className="min-w-[150px] h-[60px] mt-[30px] text-black font-semibold bg-white rounded-full text-[20px]
        ...
        <p
          className="text-white text-[18px] cursor-pointer hover:text-blue-100"
